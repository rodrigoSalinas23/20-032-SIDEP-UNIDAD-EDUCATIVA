...
public class ExceptionController {
    ...
    @ExceptionHandler(value = UnidadEducativaException.class)
    protected ResponseEntity<Map<String, Object>> handleUnidadEducativaException(UnidadEducativaException e, HttpServletRequest request) {
    ...
    private ResponseEntity<Map<String, Object>> getMapResponseEntity(HttpServletRequest request, Exception e) {
        int statusCode = (e instanceof UnidadEducativaException) ? HttpStatus.BAD_REQUEST.value() : HttpStatus.INTERNAL_SERVER_ERROR.value();
