...
import cl.mineduc.sidep.unidadeducativaapi.services.ProcesoService;
...
public class ExceptionControllerTest {
    ...
    public void testHandleParvuloException() {
        ...
        UnidadEducativaException exception = new UnidadEducativaException(errorMsg);

        ResponseEntity<Map<String, Object>> response = exceptionController.handleUnidadEducativaException(exception, request);
    ...
    public void testHandleMethodArgumentNotValidException() throws Exception {
        ...
        Method m = ExceptionController.class.getDeclaredMethod("handleUnidadEducativaException", UnidadEducativaException.class, HttpServletRequest.class);
